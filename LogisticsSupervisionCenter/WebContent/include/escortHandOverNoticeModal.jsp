...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="noticeAddModalTitle"><fmt:message key="trip.patrol.escort.transfer.notice"/></h4>
</div>
...
<script type="text/javascript" src="${root}/include/js/escortNoticeToPatrol.js"></script>
