			...
			<div class="panel panel-default">
				<div class="panel-heading">
       			  	<div class="pull-right col-sm-8 text-right">
       			  	 ...
       			  	 <fmt:message key="warehouselock.report.query"/>			  	
       			  </div>	        			 
...
function queryData(){
	 var settings = {
        type: "POST",
        url:"${root}/analysis/queryPatrolEcharts.action",
        dataType:"json",
...
<script type="text/javascript">
    	...
    	function chartPaint(dat,containArr){
            ...
            var timeOption = {
                ...
                legend: {
                    data:['<fmt:message key="performance.timeOption.legend.onlinetime"/>']
                },
                yAxis: {
                    data: userNameArr
                },
            ...
            var numOption = {
                    ...
                    legend: {
                        data:['<fmt:message key="performance.table.dealAlarmTotalAmount"/>']
                    },
                    yAxis: {
                        data: userNameArr
                    },
                    xAxis: {},
                    series: [{
                        name: "<fmt:message key="performance.table.dealAlarmTotalAmount"/>",
                        type: 'bar',
                        data: userDealNum
                    }]
                };
