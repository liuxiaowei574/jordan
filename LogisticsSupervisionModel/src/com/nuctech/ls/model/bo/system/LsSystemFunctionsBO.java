...
public class LsSystemFunctionsBO implements Serializable {
    ...
    public LsSystemFunctionsBO(String functionId, String functionName, String functionType, String functionPath,
            String levelCode, String parentId, String isEnable) {
        super();
    ...
    /** 该菜单(二级菜单)后面是否要插入分隔符 */
    private String afterIsSeperator;
    ...
    @Column(name = "AFTER_IS_SEPERATOR", nullable = true, length = 1)
    public String getAfterIsSeperator() {
        return afterIsSeperator;
    }

    public void setAfterIsSeperator(String afterIsSeperator) {
        this.afterIsSeperator = afterIsSeperator;
    }
