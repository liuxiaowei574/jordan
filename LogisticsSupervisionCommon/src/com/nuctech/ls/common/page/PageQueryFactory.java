...
public class PageQueryFactory {
    ...
    static Logger logger = Logger.getLogger(PageQueryFactory.class);
    ...
    public static PageQuery newPageQuery(HttpServletRequest request, String defaultSortColumns) {
        ...
        // PageQuery<Map> result = ExtremeTablePageRequestFactory.bindPageQuery(pageQuery,
     ...
     * 绑定PageQuery的属性值
     */
    private static PageQuery<Map> bindPageQuery(PageQuery pageQuery, HttpServletRequest request,
        ...
        String table_alias = "";
        // 获取表别名
        if (StringUtils.contains(defaultSortColumns, ".")) {
            table_alias = StringUtils.substringBefore(defaultSortColumns, ".");
        }
        if (StringUtils.isNotBlank(sortColumNname) && StringUtils.isNotBlank(sortOrder)) {
            if ("".equals(table_alias)) {
                defaultSortColumns = sortColumNname + " " + sortOrder;
            } else {
                defaultSortColumns = table_alias + "." + sortColumNname + " " + sortOrder;
            }
