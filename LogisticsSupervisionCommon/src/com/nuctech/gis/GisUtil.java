...
public class GisUtil {
    ...
    public static boolean isPointOnPolyline(GisPoint point, List<GisPoint> polyline, double buffer)
    {
		...
		for (int i = 0; i < polyline.size(); i++) {
			Coordinate coordinate = new Coordinate(polyline.get(i).getLng(),
					polyline.get(i).getLat());
    ...
    public static double pointToSegDist(GisPoint point, GisPoint point1, GisPoint point2){
    	return pointToSegDist(point.getLng(), point.getLat(), point1.getLng(), point1.getLat(), point2.getLng(), point2.getLng());
    }
	 ...
	 * @return
	 */
	private static double pointToSegDist(double x, double y, double x1,
