...
public class ConstantConfig {
    ...
    public static String readValue(String key) {
        try {
            if (props == null) {
                ...
                InputStream in = ConstantConfig.class.getResourceAsStream("/ConstantConfig.properties");
                props.load(in);
            }
    ...
    public static Object parseObject(String value, Class parseClass, Object defauleValue) {
        if (value == null)
            return defauleValue;
